...
### 1.2.2 每个IoC容器对应哪些类型组件

图解：

![](https://secure2.wostatic.cn/static/w2NYE3xCxPHJgjjQWFUVc9/image.png?auth_key=1728636154-ocbPBUSKSbxhBoNBmmURLJ-0-84a45643e5105e4357999ae98047799d)
...
### 1.2.3 IoC容器之间关系和调用方向

情况1：两个无关联IoC容器之间的组件无法注入！

![](https://secure2.wostatic.cn/static/vMfLzz8fAT5feTQFNQk2Ck/image.png?auth_key=1728636154-2Ag1E66uxceFMLbpDt6g3q-0-f1978529698836488832a0203ead5107)

情况2：子IoC容器可以单向的注入父IoC容器的组件！

![](https://secure2.wostatic.cn/static/uxEKuZFmyxEeSQeSKUNHFQ/image.png?auth_key=1728636154-4ZZ9KHBTQjhEkzYHuKM79e-0-1b2658d34de05541dd69b598e246a8b0)
...
![](https://secure2.wostatic.cn/static/pQrtrPTd58c7H4pWVDh7ZP/image.png?auth_key=1728636154-9BpamVvmSy8xTjs7gnXyXz-0-f2f9cf1ef52d9d8516defedc1b473770)

### 1.2.4 具体多少配置类以及对应容器关系

配置类的数量不是固定的，但是至少要两个，为了方便编写，我们可以三层架构每层对应一个配置类，分别指定两个容器加载即可！

![](https://secure2.wostatic.cn/static/wM8R1HinFEYDuGfbRi5xjD/image.png?auth_key=1728636154-jZfrcwERWiGNvyPrLUuCCD-0-3837e99e6733321bec8b073f8924f1de)
...
![](https://secure2.wostatic.cn/static/wEKxog3yiwNGhcfNwg6Aug/image.png?auth_key=1728636154-qQb4zhYvK4phddWbmTMuyu-0-aabec0fcfde09dfd6a2f03fbcb85bec6)
...
3. **整合方式1** （保留mybatis-config.xml）
    1. 介绍
        ...
        ![](https://secure2.wostatic.cn/static/gAu9k8yPfZDhYCSQHCLbC8/image.png?auth_key=1728636155-aU4LcaJDwRexP8T6oJrvNy-0-0fd3f56503d56e02f443ac96356ac4c5)
...
4. **整合方式2（完全配置类 去掉mybatis-config.xml）**
    1. 介绍
        ...
        ![](https://secure2.wostatic.cn/static/2JhkSCyCAyAihmQGsjw7zd/image.png?auth_key=1728636155-mGxYrDSy92F6TtZ2UKB3RL-0-2ffdb02753f970dd013b6066e1676da0)
...
![](https://secure2.wostatic.cn/static/7zSuCEEGmTUA6ErSHyy8ga/image.png?auth_key=1728636156-fRE1Qe2j5vZxGnkp71sqaK-0-3b1f1e42c83db2d3decf9b85a7e445eb)
...
![](https://secure2.wostatic.cn/static/a35sFbX59L9HWAFkUznjQ/image.png?auth_key=1728636156-m3vNp1uB2LH2i4CD6bGFUC-0-f8c15427add8636c6b6abf2117e415a3)
...
1. 后台项目根路径设计
    ...
    ![](https://secure2.wostatic.cn/static/54wi7bwJfuF1Dc5Z6vLbPq/image.png?auth_key=1728636156-6mWn2wPp72rYYKyKopHMWA-0-b7f6a8ae8a83182df5158afcf4ec54af)
2. 启动测试即可